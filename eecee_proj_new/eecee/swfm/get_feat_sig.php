...
if (is_ajax()) {
    ...
    */
    ...
    $logfile->logfile_writeline("the encoded feat_sig is-----------------------------------------------".$feat_sig);
    $logfile->logfile_writeline("the decoded feat_sig is-----------------------------------------------".$feat_sig_decoded); 

    //$_SESSION["role_sig"] = $role_sig_decoded;
