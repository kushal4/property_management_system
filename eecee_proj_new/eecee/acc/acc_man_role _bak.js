...
function set_target_role_sig_sess(target_sig, type){
	...
	$.ajax({
		method: "POST",
		url: "../orphan/set_target_role_sig_sess.php",
		data: { k: JSON.stringify(object) },
		dataType: "json",
		success: function (data, textStatus, jQxhr) {
			console.log("add_new_topics::AJAX Return: ");
...
function update_role_n_category(node_id, updated_name, updated_description, type){
	...
	$.ajax({
		method: "POST",
		url: "update_role_n_category.php",
		data: { k: JSON.stringify(object) },
		dataType: "json",
		success: function (data, textStatus, jQxhr) {
			console.log("add_new_topics::AJAX Return: ");
...
function customMenu(node) {
	...
	var cpy_lbl = $("#roll_tree").data("cpy_lbl");
	var cut_lbl = $("#roll_tree").data("cut_lbl");
...
$(document).ready(function(){
	...
	$('#roll_tree').on('delete_node.jstree', function (e, obj ) {
	...
	$('#roll_tree').on('cut.jstree', function (e, data) {
		//alert("CUT....!!!");
		//console.log("moved");
		console.log(parent);
		//console.log(this);
		...
		$("#roll_tree").data("cut_lbl",node_arr.label);
	});

	$('#roll_tree').on('copy.jstree', function (e, data) {
		//alert("COPY....!!!");
		//console.log("moved");
		//console.log(data);
		//console.log(e);
	...
	$('#roll_tree').on('paste.jstree', function (e, data) {
		...
		var lbl = $("#roll_tree").data("cpy_lbl");
	...
	$('#roll_tree').on('rename_node.jstree', function (e, data) {
	...
	$("#test_btn").on('click', function (e) {
		...
		$('#roll_tree').jstree(true).refresh_node(node_obj);
