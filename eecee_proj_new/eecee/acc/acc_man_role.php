...
$features_pg_sec_left = insertPageSection($acc_man_role_parent_container, '', '{"class":"acc-man-role-page-section"}');
$features_pg_sec_right = insertPageSection($acc_man_role_parent_container, '', '{"class":"acc-man-role-page-section"}');


$maintabs = new jqueryui_tabs_widget("test_tab");
$maintabs->setParent($features_pg_sec_left);

$tab01 = $maintabs->insertTab("tabs_1", "Category View");
$tab02 = $maintabs->insertTab("tabs_2", "Creator View");
...
$role_tree_container = insertElement($tab01,"div",'{"class":"user_prop_container role_tree_man"}'," ");  
addAttribToElement($role_tree_container, '{"id":"roll_tree"}');

$creator_view_container = insertElement($tab02,"div",'{"id":"","class":"user_prop_container"}'," "); 
//$test_btn = insertElement($features_pg_sec,"button",'{"id":"test_btn"}',"test");  


$permission_cont = insertPageSection($features_pg_sec_right, '', '{"id":"permission_cont", "class":"permission_cont_style"}');
